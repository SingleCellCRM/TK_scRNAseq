...
sce <- sce[,sce$CellLine == "404C2"]
# line not present in all chips
sce$Chip <- droplevels(sce$Chip)
...
# There is a small drop at 23 PCs. 
reducedDim(sce, "PCA") <- reducedDim(sce, "PCA")[,1:23]
``` 
