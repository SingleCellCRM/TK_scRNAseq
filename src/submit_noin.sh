...
#   qsub -N cellranger_"$n" -hold_jid stagein_"$n" runCellRanger.sh $SAMPLE
    qsub -N cellranger_"$n" runCellRanger.sh $SAMPLE    
    qsub -N stageout_"$n" -hold_jid cellranger_"$n" stageout.sh $SAMPLE
...
#   qsub -N cellranger_"$n" -hold_jid stagein_"$n" runCellRanger.sh $SAMPLE
    qsub -N cellranger_"$n" -hold_jid stageout_"$((n-1))" runCellRanger.sh $SAMPLE
    qsub -N stageout_"$n" -hold_jid cellranger_"$n" stageout.sh $SAMPLE
