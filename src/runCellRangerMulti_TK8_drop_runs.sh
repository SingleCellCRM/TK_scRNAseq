...
IDFILE=/exports/eddie/scratch/$USER/TK/src/samples_drop_runs.txt
...
# run cellranger
cellranger multi --id="TK_8" --csv=$csv 

mkdir -p /exports/eddie/scratch/$USER/TK/outs/CellRanger_drop_runs/
rsync -rl TK_8/outs/per_sample_outs/TK_8A/web_summary.html /exports/eddie/scratch/$USER/TK/outs/CellRanger_drop_runs/${SAMPLE}.html
